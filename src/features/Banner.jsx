...
const Banner = () => {
    return(
        <section className='flex justify-center items-center flex-col h-full' style={{background: '#F1EFEF'}}>
            <div className='flex justify-center items-center w-full h-full'>
                <div className='w-6/12 h-full'>
                    ...
                    <div className='mx-28 mt-6 flex justify-start items-center'>
                        <button className='py-3 px-5 mr-4 text-sm rounded-lg bg-gray-700 hover:bg-gray-600 duration-200 text-white'>Show Now</button>
